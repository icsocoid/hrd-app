...
import com.sia.als.activity.CodeActivity;
...
public class SplashActivity extends AppCompatActivity {
    ...
    public void go_next() {
        //Log.i("subdomain",SessionManagement.getNamaSubdomain());
        ...
        if (sessionManagement.isLoggedIn()) {
            ...
            {
                Intent startmain = new Intent(SplashActivity.this, CodeActivity.class);
                startActivity(startmain);
            }
            else {
