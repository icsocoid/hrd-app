...
public class SlipGajiBonusAdapter extends RecyclerView.Adapter<SlipGajiBonusAdapter.MyViewHolder> {
    List<SlipGaji> modelList;
    Context context;
    public Locale localeID;
    public NumberFormat numberFormat;

    public SlipGajiBonusAdapter(Context context, List<SlipGaji>modelList){
    ...
    public MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        return new SlipGajiBonusAdapter.MyViewHolder(itemView);
    }
    ...
    public void onBindViewHolder(@NonNull MyViewHolder holder, int position) {
        ...
        holder.namaGajiTxt.setText(mList.getNamaBonusGaji());
        holder.jumlahGajiTxt.setText(numberFormat.format(Double.parseDouble(String.valueOf(mList.getJumlahBonusGaji()))));
    }
