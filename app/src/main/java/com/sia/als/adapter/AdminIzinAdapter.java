...
public class AdminIzinAdapter extends RecyclerView.Adapter<AdminIzinAdapter.MyViewHolder> {
    ...
    public AdminIzinAdapter(Context context,List<Pengajuan> modelList)
    {
    ...
    @Override
    public AdminIzinAdapter.MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View itemView = LayoutInflater.from(parent.getContext()).inflate(R.layout.row_admin_izin, parent, false);
        context = parent.getContext();
        return new AdminIzinAdapter.MyViewHolder(itemView);
    }

    @Override
    public void onBindViewHolder(AdminIzinAdapter.MyViewHolder holder, final int position) {
        final Pengajuan mList = modelList.get(position);
        holder.namaKaryawanTxt.setText(mList.getNamaKaryawan());
        holder.statusIzinTxt.setText(mList.getStatus_izin());
        holder.jenisTxt.setText(mList.getNama_izin());
        ...
        try {
            ...
            holder.waktuIzinTxt.setText(tglAwal+"-"+tglSelesai);
        }
    ...
    public void insertData(List<Pengajuan> items) {
        setLoaded();
