...
public class NotifikasiPengajuanAbsensiFragment extends Fragment {
    private View view;
    ...
    NotifikasiPengajuanAbsensiAdapter notifikasiPengajuanAbsensiAdapter;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        toolbarTitle.setText("Histori Pengajuan Absensi");
        backButton.setVisibility(View.GONE);
        setDariTanggal("");
        setSampaiTanggal("");
        imageView = (ImageView) view.findViewById(R.id.img_choose_date);
        rvNotif = (RecyclerView) view.findViewById(R.id.list_pengajuan_absensi);
...
//                showAddTerlambatFragment();
    ...
    private void resetData()
    {
        ...
        page = 0;
        data = new ArrayList<>();
        notifikasiPengajuanAbsensiAdapter = null;
        makeDataRequest(page);
    }
...
//    }
    ...
    public void makeDataRequest(int halaman) {
        ...
        CustomVolleyJsonRequest jsonObjReq = new CustomVolleyJsonRequest(Request.Method.POST,
                Config.NOTIF_PENGAJUAN, params, new Response.Listener<JSONObject>() {
                    ...
                    if (status) {
                        ...
                        try {
                            ...
                            for (int i = 0; i < Jarray.length(); i++) {
                                ...
                                PengajuanAbsensi notifikasi = new PengajuanAbsensi();
                                notifikasi.setId(json_data.getString("id"));
                                notifikasi.setNama_karyawan(json_data.getString("nama_karyawan"));
                                notifikasi.setStatus_notif(json_data.getString("status_notif"));
                                notifikasi.setStatus_pengajuan(json_data.getString("status_pengajuan"));
                                notifikasi.setJenis_pengajuan(json_data.getString("nama_pengajuan"));
                                notifikasi.setKeterangan(json_data.getString("keterangan"));
                                notifikasi.setTanggal(json_data.getString("tanggal"));
                                data.add(notifikasi);
                            }
                            if(notifikasiPengajuanAbsensiAdapter == null)
                            {
                                isFirst = false;
                                notifikasiPengajuanAbsensiAdapter = new NotifikasiPengajuanAbsensiAdapter(getContext(),data);
                                notifikasiPengajuanAbsensiAdapter.setOnItemClickListener(new NotifikasiPengajuanAbsensiAdapter.OnItemClickListener(){
                                    @Override
...
//                                addAbsensiBtn.show();
                                rvNotif.setAdapter(notifikasiPengajuanAbsensiAdapter);
                                rvNotif.smoothScrollToPosition(0);

                            }else{
                                notifikasiPengajuanAbsensiAdapter.notifyDataSetChanged();
                            }
                            isLoading = false;
