...
import com.sia.als.model.Peraturan;
...
public class PeraturanFragment extends Fragment {
    ...
    //List<Peraturan> data = new ArrayList<>();
    //String idPeraturan = "";
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        view = inflater.inflate(R.layout.fragment_peraturan, container, false);
        ...
        toolbarTitle.setText("Peraturan & Tata Tertib");
    ...
    private void makeDataRequest() {
        ...
        dialog.show();
        String tag_json_obj = "json_data_peraturan_req";
