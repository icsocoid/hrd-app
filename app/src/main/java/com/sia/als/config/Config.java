...
public class Config {
    ...
    public static String BASE_INIT_URL = "http://icsodev.biz.id/public/api/user/get-code";
    public static String NAMADOMAIN = "icsodev.biz.id";
    ...
    public static String HOME_URL = BASE_URL + "api/karyawan/home";
    ...
    public static String IZIN_URL = BASE_URL + "api/karyawan/history-izin";
    public static String IZIN_HISTORY_URL = BASE_URL + "api/karyawan/history-izin";
    public static String REKAP_IZIN_URL = BASE_URL + "api/karyawan/history-izin";
